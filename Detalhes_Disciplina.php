...
if (isset($_POST['relacao'])) {
    ...
    $confirmacao = mysqli_query($conectar,$sql);
			...
			<div class="panel-body">
			 ...
			 <div class="row">
			  ...
			  <div class="col col-sm-3">
				  ...
				  <?php
                  $sqlquery = "SELECT * FROM disciplina ORDER BY Nome";
				...
				<div class="col-sm-3">
				  ...
				  $sqlqueryy = "SELECT * FROM professor ORDER BY Nome";
                  $query=mysqli_query($conectar,$sqlqueryy);
                  ?>
				...
				<div class="col-sm-3">
				  ...
				  <?php
                  $sqlqueryyy= "SELECT * FROM tabela_turma ORDER BY nomeTurma";
                  $query=mysqli_query($conectar, $sqlqueryyy);
                  ?>
             ...
             <div class="table-responsive">
				...
				$sqres= "SELECT * FROM `detalhes_disciplina` 
				...
				$resultado = mysqli_query($conectar,$sqres);?>
