...
if (isset($_POST['buscar'])) {
	...
	$sql= "select * from Professor where Nome LIKE '$pesquisar%' or `Apelido` LIKE '$pesquisar%'";
        ...
        <div class="panel-body">
             ...
             <div class="col col-xs-12 col-md-12 col-sm-12 col-lg-12">
              		<p class="hidden">
								...
								<label for="texto">Número de Professores: <?php  $num = mysqli_num_rows($resultado);  echo "$num"; ?></label>
              		</p> 
            <div class="row-fluid">
