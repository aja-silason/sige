...
<?php
	...
	//Executa consulta
	$sqlinscr = "SELECT * FROM inscricao WHERE numeroBI = '$idCandidato' LIMIT 1";
	$result = mysqli_query($conectar, $sqlinscr);
          ...
          <div class="col-sm-12">
			  ...
			  <div class="col-sm-4">
				...
				<?php
				  ...
				  $sqlquery ="SELECT * FROM tabela_turma WHERE nomeTurma like '$classe%' ORDER BY idTurma";
