...
if (isset($_POST['buscar'])) {
	...
	$sql= "select * from funcionario where Nome LIKE '$pesquisar%' OR `Apelido` LIKE '$pesquisar%'";
    $resultado = mysql_query($conectar,$sql);
        ...
        <div class="panel-body">
              ...
              <div class="col col-xs-12 col-md-12 col-sm-12 col-lg-12">
              		<p class="hidden">
								...
								<label for="texto">Número de Funcionarios: <?php  $num = mysqli_num_rows($resultado);  echo "$num"; ?></label>
              		</p> 
            <div class="row-fluid">
