...
if(isset ($_POST['cadastrarEstudante'])){
	...
	$Estudante_resultado = mysqli_query($conectar,$verifica_Estudante);
	$Estudante_resultado1 = mysqli_query($conectar,$verifica_Estudante1);
	$Estudante_resultado2 = mysqli_query($conectar,$verifica_Estudante2);
	$Estudante_resultado3 = mysqli_query($conectar,$verifica_Estudante3);
	$Estudante_resultado4 = mysqli_query($conectar,$verifica_Estudante4);
	if(mysqli_num_rows($Estudante_resultado) > 0){
			$_SESSION['mensagem'] = "
	...
	elseif(mysqli_num_rows($Estudante_resultado4) > 0){
	...
	elseif(mysqli_num_rows($Estudante_resultado2) > 0){
	...
	elseif(mysqli_num_rows($Estudante_resultado1) > 0){
	...
	if(mysqli_num_rows($Estudante_resultado3) > 0){
	...
	elseif(mysqli_num_rows($Estudante_resultado) > 0){
						...
						<div class="panel-body">
				          ...
				          <div class="col-sm-12">
							...
							<div class="col-sm-12">
							  ...
							  <div class="col-sm-2">
								Ano de saida:
								  <input type="text" class="input-sm form-control" name="Ano_Saida" maxlength="9" placeholder="Ex: 2017" required>
								</div>
							  <div class="col-sm-4">
								Classe frequentada:
