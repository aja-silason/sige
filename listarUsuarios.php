...
if (isset($_POST['buscar'])) {
	...
	$sql="SELECT *, tabela_nivel_acesso.nomeNivelAcesso as nomenivel FROM tabela_usuarios INNER JOIN tabela_nivel_acesso ON tabela_nivel_acesso.idNivelAcesso= tabela_usuarios.idNivelAcesso WHERE idUsuario LIKE '$pesquisar%' or Nome LIKE '$pesquisar%'";
    $resultado = mysqli_query($conectar,$sql);
    unset($_POST['buscar']);
}else{
	$sql="SELECT *, tabela_nivel_acesso.nomeNivelAcesso as nomenivel FROM tabela_usuarios INNER JOIN tabela_nivel_acesso ON tabela_nivel_acesso.idNivelAcesso= tabela_usuarios.idNivelAcesso ORDER BY 'idUsuario'";
	$resultado = mysqli_query($conectar,$sql);
        ...
        <div class="panel-body">
              ...
              <div class="col col-xs-12 col-md-12 col-sm-12 col-lg-12">
              		<p class="hidden">
								...
								<label for="texto">Número de Usuários: <?php  $num = mysqli_num_rows($resultado);  echo "$num"; ?></label>
              		</p> 
            <div class="row-fluid">
