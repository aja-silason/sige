...
<?php
				...
				if (isset($_POST['buscar'])) {
					...
					$sqlres = "SELECT * from inscricao where Nome LIKE '$pesquisar%' or Apelido LIKE '$pesquisar%'";
    				$resultado = mysqli_query($conectar, $sqlres);   						
				}else{
					$slqrsd = "SELECT * from inscricao";
						$resultado = mysqli_query($conectar, $slqrsd);
				}
				unset($_POST['buscar']);
        ...
        <div class="panel-body">
            ...
            <div class="col col-xs-12 col-md-12 col-sm-12 col-lg-12">
              		<p class="">
								...
								<label for="texto">Número de candidatos: <?php  $num = mysqli_num_rows($resultado);  echo "$num"; ?></label>
              		</p> 
            <div class="row-fluid">
				...
				<form name="Conf_Inscricao" method="POST" action="Conf_Inscricao.php">
					<div class="modal-body">
						<div class="form-group">
							...
							$querytabela= "SELECT * FROM tabela_turma";
							$query=mysqli_query($conectar, $querytabela);
